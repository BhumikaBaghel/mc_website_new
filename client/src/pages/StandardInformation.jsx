import iso_27001 from "@/assets/standard_logos/iso27002white.png";
import iso_27701 from "@/assets/standard_logos/iso27701white.png";
import soc2 from "@/assets/standard_logos/soc.png"
import mpa_tpn from "@/assets/standard_logos/mpn.png";
import gdpr from "@/assets/standard_logos/gdpr-main.png";
import integration from "@/assets/standard_logos/integration.png";
import csa_star from "@/assets/standard_logos/4-1.png";
import { Link, useLocation } from "wouter";
import nist_csf from "@/assets/standard_logos/nist_csf.webp";
import nist_800_53 from "@/assets/standard_logos/nist-800-53.png";
import iso_27017 from "@/assets/standard_logos/iso_27017.png";
import iso_27018 from "@/assets/standard_logos/iso_27018.png";
import custom_frameworks from "@/assets/standard_logos/custom_framewroks.avif";
import iso_22301 from "@/assets/standard_logos/iso_22301.png";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center mt-20 mb-20 px-4 md:px-10">
      <div className="flex flex-col">
        ...
        <div
          className="text-sm md:text-base font-normal text-white font-times leading-relaxed"
          dangerouslySetInnerHTML={{ __html: obj.text }}
        ></div>
        <Link
          to="/contact_form"
          className="w-fit text-sm font-semibold bg-gradient-to-r from-pink-700 to-red-600 mt-4 text-white py-3 px-6 rounded shadow-lg hover:scale-105 transition"
        >
          Get Started
        </Link>
      </div>
